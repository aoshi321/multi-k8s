...
kubectl set image deployments/client-deployment clientr=aoshi/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=aoshi/multi-worker:$SHA
